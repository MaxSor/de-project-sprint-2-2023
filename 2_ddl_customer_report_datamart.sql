...
COMMENT ON TABLE dwh.customer_report_datamart IS 'витрина по заказчикам';
...
COMMENT ON TABLE dwh.load_dates_customer_report_datamart IS 'время загрузки витрины по заказчикам';